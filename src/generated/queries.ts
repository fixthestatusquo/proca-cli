...
export type GetOrgCampaignsQuery = {
  __typename?: "RootQueryType";
  org: {
...
export function useSearchCampaignsQuery(
  options: Omit<Urql.UseQueryArgs<SearchCampaignsQueryVariables>, "query">,
) {
  return Urql.useQuery<SearchCampaignsQuery, SearchCampaignsQueryVariables>({
    query: SearchCampaignsDocument,
    ...options,
  });
}
...
export function useGetOrgCampaignsQuery(
  options: Omit<Urql.UseQueryArgs<GetOrgCampaignsQueryVariables>, "query">,
) {
  return Urql.useQuery<GetOrgCampaignsQuery, GetOrgCampaignsQueryVariables>({
    query: GetOrgCampaignsDocument,
    ...options,
  });
}
